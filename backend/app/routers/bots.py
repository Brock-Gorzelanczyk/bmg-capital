...
def get_trade_detail(
    ...
    return {
        ...
        "status": status,
        "stop_loss_usd": (signal.stop_price if signal else None) or (position.stop_price_usd if position else None),
        "take_profit_usd": (signal.target_price if signal else None) or (position.target_price_usd if position else None),
