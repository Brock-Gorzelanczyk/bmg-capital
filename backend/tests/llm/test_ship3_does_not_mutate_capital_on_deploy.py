...
(Kept in tests/llm/ for backward compat; canonical copy is tests/guards/.)
"""
...
def _load_migration(module_short: str):
    ...
    Mirrors the pattern in tests/test_migration_contract.py::_load_migration.
    """
...
def _setup_tables(conn):
    ...
    """))
    # anthropic_call_cache table (created by m028)
