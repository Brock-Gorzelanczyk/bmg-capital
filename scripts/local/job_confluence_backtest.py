...
CANDIDATES = [
    ...
    # ── Bucket 5: N=100 expansion — 50 additional names across sectors ──
    # 20 additional framework-eligible (2025 insider/analyst activity)
    ("MCD",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "McDonald's — turnaround, insider buying",     "XLY"),
    ("HAS",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "Hasbro — brand turnaround, analyst upgrades", "XLY"),
    ("CHWY", "2026-04-01", "FRAMEWORK_ELIGIBLE", "Chewy — pet retail, insider + fundamentals",  "XLY"),
    ("MS",   "2026-04-01", "FRAMEWORK_ELIGIBLE", "Morgan Stanley — wealth mgmt, insider",       "XLF"),
    ("GS",   "2026-04-01", "FRAMEWORK_ELIGIBLE", "Goldman Sachs — trading + upgrades",          "XLF"),
    ("BLK",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "BlackRock — ETF flows, institutional",        "XLF"),
    ("USB",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "US Bancorp — regional bank recovery",         "XLF"),
    ("GILD", "2026-04-01", "FRAMEWORK_ELIGIBLE", "Gilead — pipeline + dividend",                "XLV"),
    ("CVS",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "CVS Health — turnaround, insider buying",     "XLV"),
    ("ABBV", "2026-04-01", "FRAMEWORK_ELIGIBLE", "AbbVie — pipeline post-Humira",               "XLV"),
    ("UNH",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "UnitedHealth — value after selloff",          "XLV"),
    ("RTX",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "RTX Corp — defense contracts",                "XLI"),
    ("LMT",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "Lockheed Martin — defense backlog",           "XLI"),
    ("DAL",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "Delta — airline recovery, upgrades",          "XLI"),
    ("IBM",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "IBM — hybrid cloud, insider buying",          "XLK"),
    ("HPQ",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "HP Inc — buybacks, insider",                  "XLK"),
    ("EQIX", "2026-04-01", "FRAMEWORK_ELIGIBLE", "Equinix — data center REIT",                  "XLRE"),
    ("DLR",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "Digital Realty — AI data center demand",      "XLRE"),
    ("EOG",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "EOG Resources — E&P, insider + dividend",     "XLE"),
    ("KMI",  "2026-04-01", "FRAMEWORK_ELIGIBLE", "Kinder Morgan — midstream, insider",          "XLE"),

    # 15 additional 2025 winners (mega-cap tech + AI plays)
    ("MU",   "2026-04-01", "KNOWN_WINNER",   "Micron — memory + AI HBM",                    "XLK"),
    ("MRVL", "2026-04-01", "KNOWN_WINNER",   "Marvell — AI networking chips",               "XLK"),
    ("KLAC", "2026-04-01", "KNOWN_WINNER",   "KLA — semi equipment",                        "XLK"),
    ("AMAT", "2026-04-01", "KNOWN_WINNER",   "Applied Materials — semi equipment",          "XLK"),
    ("QCOM", "2026-04-01", "KNOWN_WINNER",   "Qualcomm — mobile + auto",                    "XLK"),
    ("ADBE", "2026-04-01", "KNOWN_WINNER",   "Adobe — creative + AI Firefly",               "XLK"),
    ("CRWD", "2026-04-01", "KNOWN_WINNER",   "CrowdStrike — cybersec leader",               "XLK"),
    ("PANW", "2026-04-01", "KNOWN_WINNER",   "Palo Alto Networks — cybersec",               "XLK"),
    ("ANET", "2026-04-01", "KNOWN_WINNER",   "Arista — AI networking",                      "XLK"),
    ("SNPS", "2026-04-01", "KNOWN_WINNER",   "Synopsys — EDA",                              "XLK"),
    ("CDNS", "2026-04-01", "KNOWN_WINNER",   "Cadence — EDA",                               "XLK"),
    ("ISRG", "2026-04-01", "KNOWN_WINNER",   "Intuitive Surgical — robot surgery",          "XLV"),
    ("NOW",  "2026-04-01", "KNOWN_WINNER",   "ServiceNow — AI + enterprise",                "XLK"),
    ("MA",   "2026-04-01", "KNOWN_WINNER",   "Mastercard — payment volumes",                "XLF"),
    ("SPOT", "2026-04-01", "KNOWN_WINNER",   "Spotify — subs + pricing power",              "XLC"),

    # 15 additional 2025 losers (broad set)
    ("SNAP", "2026-04-01", "KNOWN_LOSER",    "Snap — ad revenue weakness",                  "XLC"),
    ("ROKU", "2026-04-01", "KNOWN_LOSER",    "Roku — streaming ad softness",                "XLC"),
    ("PINS", "2026-04-01", "KNOWN_LOSER",    "Pinterest — user growth stall",               "XLC"),
    ("GPS",  "2026-04-01", "KNOWN_LOSER",    "Gap — retail softness",                       "XLY"),
    ("KSS",  "2026-04-01", "KNOWN_LOSER",    "Kohl's — department store collapse",          "XLY"),
    ("M",    "2026-04-01", "KNOWN_LOSER",    "Macy's — retail turnaround stalled",          "XLY"),
    ("CVNA", "2026-04-01", "KNOWN_LOSER",    "Carvana — used cars volatile",                "XLY"),
    ("CROX", "2026-04-01", "KNOWN_LOSER",    "Crocs — post-COVID hangover",                 "XLY"),
    ("WBD",  "2026-04-01", "KNOWN_LOSER",    "Warner Bros Discovery — debt + streaming",    "XLC"),
    ("FSLR", "2026-04-01", "KNOWN_LOSER",    "First Solar — policy uncertainty",            "XLE"),
    ("SIRI", "2026-04-01", "KNOWN_LOSER",    "Sirius XM — user attrition",                  "XLC"),
    ("HAL",  "2026-04-01", "KNOWN_LOSER",    "Halliburton — oil services",                  "XLE"),
    ("DVN",  "2026-04-01", "KNOWN_LOSER",    "Devon Energy — E&P weakness",                 "XLE"),
    ("APA",  "2026-04-01", "KNOWN_LOSER",    "APA Corp — E&P disappointments",              "XLE"),
    ("STX",  "2026-04-01", "KNOWN_LOSER",    "Seagate — HDD legacy pressures",              "XLK"),
]
...
COMPANY_NAMES = {
    ...
    # N=100 expansion — 50 more names
    "MCD": "McDonald's", "HAS": "Hasbro", "CHWY": "Chewy",
    "MS": "Morgan Stanley", "GS": "Goldman Sachs", "BLK": "BlackRock",
    "USB": "US Bancorp", "GILD": "Gilead Sciences", "CVS": "CVS Health",
    "ABBV": "AbbVie", "UNH": "UnitedHealth Group",
    "RTX": "RTX Corporation", "LMT": "Lockheed Martin", "DAL": "Delta Air Lines",
    "IBM": "IBM", "HPQ": "HP Inc",
    "EQIX": "Equinix", "DLR": "Digital Realty",
    "EOG": "EOG Resources", "KMI": "Kinder Morgan",
    "MU": "Micron Technology", "MRVL": "Marvell Technology", "KLAC": "KLA Corporation",
    "AMAT": "Applied Materials", "QCOM": "Qualcomm", "ADBE": "Adobe",
    "CRWD": "CrowdStrike", "PANW": "Palo Alto Networks", "ANET": "Arista Networks",
    "SNPS": "Synopsys", "CDNS": "Cadence Design Systems", "ISRG": "Intuitive Surgical",
    "NOW": "ServiceNow", "MA": "Mastercard", "SPOT": "Spotify",
    "SNAP": "Snap Inc", "ROKU": "Roku", "PINS": "Pinterest",
    "GPS": "Gap Inc", "KSS": "Kohl's", "M": "Macy's",
    "CVNA": "Carvana", "CROX": "Crocs", "WBD": "Warner Bros Discovery",
    "FSLR": "First Solar", "SIRI": "Sirius XM", "HAL": "Halliburton",
    "DVN": "Devon Energy", "APA": "APA Corporation", "STX": "Seagate Technology",
}
